...
Topics:"""
        ...
        result = topic_chain.run(context=context[:8000])  # Limit context size
...
Updates:"""
            ...
            result = extraction_chain.run(topic=topic, context=context[:6000])
...
Consolidated updates:"""
            ...
            dedup_chain = LLMChain(llm=self.llm, prompt=dedup_prompt)
            updates_str = json.dumps(batch, indent=2)
            result = dedup_chain.run(updates=updates_str)
